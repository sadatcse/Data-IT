...
const VideoProduction = () => {
  return (
    <div className="font-sans text-[#25252B] bg-white min-h-screen">
      <SEO 
        title="Video Production Services - Data IT"
        description="Engage your audience with professional video content. Data IT provides corporate videos, explainer animations, and social ads production."
        keywords="Video Production, Corporate Video Production, Explainer Videos, Motion Graphics, Social Media Shorts"
