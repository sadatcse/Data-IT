...
const PRAgency = () => {
  return (
    <div className="font-sans text-[#25252B] bg-white min-h-screen">
      <SEO 
        title="PR Agency & Reputation Management Services - Data IT"
        description="Build brand trust, visibility, and credibility. Data IT provides professional PR outreach, press release writing, and crisis communication."
        keywords="PR Agency Services, Public Relations, Reputation Management, Press Release Distribution, Brand Credibility"
        url="/pr-agency"
        siteName="Data IT"
        type="website"
      />
